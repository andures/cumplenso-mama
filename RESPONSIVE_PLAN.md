...
```jsx
width: {
  xs: "clamp(80px, 26vw, 115px)";
}
height: {
  xs: "clamp(130px, 43vw, 185px)";
}
```
...
- [x] `clamp()` en fuentes ("90", "Años", nombre) con unidades `dvh`
- [x] CSS `@media (max-height: 700px)` → iPhone SE 375×667
- [x] CSS `@media (max-height: 790px) and (min-height: 701px)` → S10/A34/S22
- [x] Photo más pequeña: 80×130px (SE) y 85×140px (S10)
- [x] Reducción de padding/gap en pantallas cortas

### Fase 3 — Implementada ✅

- [x] Query S10 zone ampliada a 840px: cubre A52/A53/A54 (360×800), A34 (360×780), S22 (360×780)
- [x] Nueva zona "wide phones" (390–599px × ≤870px): cubre S10+ (412×869), iPhone 12 mini (375×812), S23 (393×851)
- [x] Reducción de fuentes base xs en Invitation.tsx: "90" → 4.5rem, "Años" → 2.3rem, nombre → 3rem
- [x] `clamp()` dvh en todas las zonas para escala fluida proporcional
- [x] Push a Vercel
